  ...
  return (
    <div className={`flex flex-col h-full ${themeStyles.background} ${themeStyles.text}`}>
      <Tabs value={activeTab} onValueChange={onActiveTabChange} className="flex flex-col h-full">
        <div className={`border-b p-2 flex-shrink-0 ${themeStyles.border} ${themeStyles.accent}`}>
        ...
        <TabsContent value="output" className="flex-1 m-0 flex flex-col overflow-hidden">
          <div className="flex flex-col h-full">
            <div className={`p-2 border-b flex-shrink-0 ${themeStyles.border} ${themeStyles.accent}`}>
        ...
        <TabsContent value="video" className="flex-1 m-0 flex flex-col overflow-hidden">
          <div className="flex flex-col h-full">
            <div className={`p-2 border-b flex-shrink-0 ${themeStyles.border} ${themeStyles.accent}`}>
              <div className="flex items-center justify-between">
        ...
        <TabsContent value="ai" className="flex-1 m-0 flex flex-col overflow-hidden">
          <div className="flex flex-col h-full">
            ...
            <div className={`border-t p-3 flex-shrink-0 ${themeStyles.border}`}>
