...
const StacksQueues = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-orange-50">
      ...
      {/* Header */}
      <div className="pt-20 pb-12 bg-gradient-to-br from-yellow-600 to-orange-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-white">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">Stacks & Queues</h1>
            <p className="text-lg sm:text-xl text-yellow-100 max-w-3xl">
              Learn LIFO and FIFO data structures with practical applications in these problems.
            </p>
          </div>
        </div>
      </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 mb-3">
                      <h3 className="text-lg sm:text-xl font-semibold text-gray-900 group-hover:text-yellow-600 transition-colors truncate">
                        {problem.title}
                      </h3>
