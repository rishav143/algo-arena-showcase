      ...
      <div className="pt-20 pb-12 bg-gradient-to-br from-purple-600 to-pink-600">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-white">
            <h1 className="text-5xl font-bold mb-4">Trees & Graphs</h1>
            ...
            <Card key={problem.id} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-white/70 backdrop-blur-sm">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  ...
                  <Button className="bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                    Solve Now
                  </Button>
                </div>
              </CardContent>
