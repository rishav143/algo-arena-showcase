...
const ArraysStrings = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-cyan-50">
      ...
      <div className="pt-16 sm:pt-20 pb-8 sm:pb-12 bg-gradient-to-br from-emerald-600 to-cyan-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-white">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4">Arrays & Strings</h1>
            <p className="text-base sm:text-lg lg:text-xl text-emerald-100 max-w-3xl">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 mb-8 sm:mb-12">
          <Card className="bg-white/80 border-0 shadow-lg">
            <CardContent className="p-4 sm:p-6 text-center">
              <Code className="w-6 h-6 sm:w-8 sm:h-8 text-emerald-600 mx-auto mb-2" />
          ...
          <Card className="bg-white/80 border-0 shadow-lg">
            <CardContent className="p-4 sm:p-6 text-center">
              <Clock className="w-6 h-6 sm:w-8 sm:h-8 text-cyan-600 mx-auto mb-2" />
                    ...
                    <div className="flex flex-col gap-4">
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-3">
                          <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 group-hover:text-emerald-600 transition-colors">
                            {problem.title}
                          </h3>
                      ...
                      <Button className="bg-gradient-to-r from-emerald-500 to-cyan-600 hover:from-emerald-600 hover:to-cyan-700 text-white shadow-lg hover:shadow-xl transition-all duration-200 self-start w-full sm:w-auto text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3">
                        Solve Now
                      </Button>
                    </div>
                  </CardContent>
